...
export function ScenarioEditorPanel({
  ...
  const handleFileNameEditClick = () => {
    setFileNameDraft(stripJsonExtension(previewFileName))
        ...
        <div className={previewShellClassName}>
          {!isEditing && (
            <div className="scenario-editor-preview-toolbar">
              {isEditingFileName ? (
                <div className="scenario-editor-file-name-editor">
                  <input
                    ...
                    aria-label="Scenario file name without .json extension"
                    data-testid="scenario-editor-file-name-input"
                  />
                  <span className="scenario-editor-file-name-extension">
                    .json
                  </span>
                </div>
              ) : (
                <>
                  ...
                  <button
                    type="button"
                    className="scenario-editor-download-button"
