...
def generate_launch_description():
    ...
    # Shared obstacle source args (same map for sim and planner)
    ...
    initial_yaw_arg = DeclareLaunchArgument('initial_yaw', default_value='3.14159')
    ...
    goal_tol_arg = DeclareLaunchArgument('goal_tolerance', default_value='1.0')
