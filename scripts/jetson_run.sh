...
echo "Running Isaac Sim container optimized for Jetson Thor..."
...
docker run -it \
    ...
    -e ACCEPT_EULA=Y \
    -e OMNI_RTX_ENABLED=0 \
    -e OMNI_RTX_DENOISER_ENABLED=0 \
    -e OMNI_RTX_RAYTRACING_ENABLED=0 \
    -e OMNI_RENDER_MODE=rasterize \
    -e CARB_GRAPHICS_DISABLE_RTX=1 \
